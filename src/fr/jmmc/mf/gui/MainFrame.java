...
public class MainFrame extends javax.swing.JFrame
    ...
    public String doPost(String methodName) throws Exception {
        ...
        Part[] parts = { new StringPart("method", methodName) };
    ...
    // call yoga.sh with method Name
    public String doExec(String methodName, java.io.File targetFile)
        throws Exception {
        String yogaProgram = myPreferences.getPreference("yoga.local.home") +
            "/bin/yoga.sh";
    ...
    public String doPost(String methodName, java.io.File targetFile)
        throws Exception {
        String result = "";
        String targetURL = myPreferences.getPreference("yoga.remote.url");
        PostMethod myPost = new PostMethod(targetURL);
    ...
    protected class RunFitAction extends jmmc.mcs.util.MCSAction {
        ...
        public void actionPerformed(java.awt.event.ActionEvent e) {
            ...
            try {
                // Create temp file.
                java.io.File targetFile = java.io.File.createTempFile("tmpSettings",
                        ".xml");
