   ...
   static java.util.logging.Logger logger = java.util.logging.Logger.getLogger(
    ...
    public void shareParameter(Parameter myParam) {
        ...
        if (myParam.getId()==null){
            myParam.setId(myParam.getName()+
                    Integer.toHexString(myParam.hashCode()));
        }                   
    ...
    */
    class ParametersTableModel extends AbstractTableModel {
        ...
        protected final String[] columnNames = new String[] {
                "Name", "Type", "Units", "Value", "MinValue", "MaxValue",
                "Scale", "HasFixedValue"
            };
        ...
        protected void addParamsFor(Model model, Vector paramContainer,
            Vector modelContainer, boolean recursive) {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            try {
                ...
                Method get = Parameter.class.getMethod(getMethodName,
                        new Class[0]);

                String hasMethodName = "has" + columnNames[columnIndex];

                try {
                    Method has = Parameter.class.getMethod(hasMethodName,
                            new Class[0]);
        ...
        public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
            ...
            logger.fine("parameter " + p.getName() + "@" + m.getName() +
                " old:" + getValueAt(rowIndex, columnIndex) + " new:" + aValue +
                "(" + aValue.getClass() + ")");
