...
public class TargetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TargetDescriptor() {
        ...
        desc.setComponentType("fr.jmmc.mf.models.FileLink");
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                Target target = (Target) object;
                if (!target.hasNormalize()) { return null; }
                return (target.getNormalize() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setNormalize( ((java.lang.Boolean) value).booleanValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setSchemaType("fr.jmmc.mf.models.Residuals");
        desc.setHandler(handler);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
        addSequenceElement(desc);
